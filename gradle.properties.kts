...
val 
val POM_DEVELOPER_ID= "JimAndreas"
val POM_DEVELOPER_NAME= "Jim Andreas"

val POM_NAME= "Protein DataBase (PDB) parser in Kotlin."
val POM_ARTIFACT_ID= "library"
val POM_PACKAGING= "jar"